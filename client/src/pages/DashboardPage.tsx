...
import { Wallet, Star, Bell, TrendingUp, Award, BarChart2 } from 'lucide-react';
  ...
  return (
    <div className="p-4 lg:p-6 space-y-6">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <DashboardCard icon={Star} label="Favorites" value={`${profile.favoriteMatches.length}`} sub="Saved matches" color="bg-purple-500" />
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        {/* Favorite sports */}
        <div className="space-y-3">
          <h2 className="font-bold text-white flex items-center gap-2"><Star className="w-4 h-4 text-brand-400" />Favorite Sports</h2>
          <div className="space-y-2">
